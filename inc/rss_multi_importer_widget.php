...
class WP_Multi_Importer_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget Title', 'wp-rss-multi-importer'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>"
                   name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>"/>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('showicon'); ?>"
                   name="<?php echo $this->get_field_name('showicon'); ?>" type="checkbox"
                   value="1" <?php checked('1', $showicon); ?>/>
            <label
                for="<?php echo $this->get_field_id('showicon'); ?>"><?php _e('Show RSS icon', 'wp-rss-multi-importer'); ?></label>
        </p>

        <p>
            <label
                for="<?php echo $this->get_field_id('linktitle'); ?>"><?php _e('URL to link title to another page (optional)', 'wp-rss-multi-importer'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('linktitle'); ?>"
                   name="<?php echo $this->get_field_name('linktitle'); ?>" type="text"
                   value="<?php echo $linktitle; ?>"/>
        </p>
        ...
        <p>
            ...
            <label
                for="<?php echo $this->get_field_id('targetwindow'); ?>"><?php _e('Target Window', 'wp-rss-multi-importer'); ?></label>


            <select name="<?php echo $this->get_field_name('targetwindow'); ?>">


                <OPTION ID="0" VALUE="0" <?php if ($targetwindow == 0) {
                    echo 'selected="selected"';
                } ?>>Use LightBox
                </OPTION>
                <OPTION ID="1" VALUE="1" <?php if ($targetwindow == 1) {
                    echo 'selected="selected"';
                } ?>>Open in Same Window
                </OPTION>
                <OPTION ID="2" VALUE="2" <?php if ($targetwindow == 2) {
                    echo 'selected="selected"';
                } ?>>Open in New Window
                </OPTION>
            </SELECT>
        ...
        <p>
            ...
            <label
                for="<?php echo $this->get_field_id('checkbox'); ?>"><?php _e('Check to sort ascending', 'wp-rss-multi-importer'); ?></label>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('showdate'); ?>"
                   name="<?php echo $this->get_field_name('showdate'); ?>" type="checkbox"
                   value="1" <?php checked('1', $showdate); ?>/>
            <label
                for="<?php echo $this->get_field_id('showdate'); ?>"><?php _e('Show date', 'wp-rss-multi-importer'); ?></label>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('showdesc'); ?>"
                   name="<?php echo $this->get_field_name('showdesc'); ?>" type="checkbox"
                   value="1" <?php checked('1', $showdesc); ?>/>
            <label
                for="<?php echo $this->get_field_id('showdesc'); ?>"><?php _e('Show excerpt (will not show if scrolling)', 'wp-rss-multi-importer'); ?></label>
        </p>


        <p>
            <input id="<?php echo $this->get_field_id('showimage'); ?>"
                   name="<?php echo $this->get_field_name('showimage'); ?>" type="checkbox"
                   value="1" <?php checked('1', $showimage); ?>/>
            <label
                for="<?php echo $this->get_field_id('showimage'); ?>"><?php _e('Show image (will not show if scrolling)', 'wp-rss-multi-importer'); ?></label>
        </p>


        <p>
            <input id="<?php echo $this->get_field_id('showsource'); ?>"
                   name="<?php echo $this->get_field_name('showsource'); ?>" type="checkbox"
                   value="1" <?php checked('1', $showsource); ?>/>
            <label
                for="<?php echo $this->get_field_id('showsource'); ?>"><?php _e('Show feed source)', 'wp-rss-multi-importer'); ?></label>
        </p>


        <p><label
                for="<?php echo $this->get_field_id('rssdefaultimage'); ?>"><?php _e('Default category image setting', 'wp-rss-multi-importer'); ?></label>
            <select name="<?php echo $this->get_field_name('rssdefaultimage'); ?>">

                <OPTION VALUE="0" <?php if ($rssdefaultimage == 0) {
                    echo 'selected';
                } ?>>Process normally
                </OPTION>
                <OPTION VALUE="1" <?php if ($rssdefaultimage == 1) {
                    echo 'selected';
                } ?>>Only use default image
                </OPTION>
                <OPTION VALUE="2" <?php if ($rssdefaultimage == 2) {
                    echo 'selected';
                } ?>>When no image, use default
                </OPTION>
        ...
        <p><label
                for="<?php echo $this->get_field_id('descnum'); ?>"><?php _e('Words in excerpt', 'wp-rss-multi-importer'); ?></label>
            <select name="<?php echo $this->get_field_name('descnum'); ?>">

                <OPTION VALUE="0" <?php if ($descnum == 0) {
                    echo 'selected';
                } ?>>None
                </OPTION>
                <OPTION VALUE="10" <?php if ($descnum == 10) {
                    echo 'selected';
                } ?>>10
                </OPTION>
                <OPTION VALUE="20" <?php if ($descnum == 20) {
                    echo 'selected';
                } ?>>20
                </OPTION>
                <OPTION VALUE="30" <?php if ($descnum == 30) {
                    echo 'selected';
                } ?>>30
                </OPTION>
                <OPTION VALUE="40" <?php if ($descnum == 40) {
                    echo 'selected';
                } ?>>40
                </OPTION>
                <OPTION VALUE="50" <?php if ($descnum == 50) {
                    echo 'selected';
                } ?>>50
                </OPTION>
            </SELECT></p>
        ...
        <p>
            <input id="<?php echo $this->get_field_id('addmotion'); ?>"
                   name="<?php echo $this->get_field_name('addmotion'); ?>" type="checkbox"
                   value="1" <?php checked('1', $addmotion); ?>/>
            <label
                for="<?php echo $this->get_field_id('addmotion'); ?>"><?php _e('Check to add scrolling motion', 'wp-rss-multi-importer'); ?></label>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('simplelist'); ?>"
                   name="<?php echo $this->get_field_name('simplelist'); ?>" type="checkbox"
                   value="1" <?php checked('1', $simplelist); ?>/>
            <label
                for="<?php echo $this->get_field_id('simplelist'); ?>"><?php _e('Check to get just a simple unordered list', 'wp-rss-multi-importer'); ?></label>
        </p>


        <p>
            <label
                for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Which category do you want displayed?', 'wp-rss-multi-importer'); ?></label>
            <select name="<?php echo $this->get_field_name('category'); ?>[]"
                    id="<?php echo $this->get_field_id('category'); ?>" class="widefat" multiple="multiple">
                <option id="All"
                        value="0" <?php echo in_array(0, (array)$instance['category']) ? ' selected="selected"' : ''?>>
                    ALL CATEGORIES
                </option>
                <?php
                if (!empty($options)) {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('numoption'); ?>"><?php _e('How many total results displayed?', 'wp-rss-multi-importer'); ?></label>
            <select name="<?php echo $this->get_field_name('numoption'); ?>"
                    id="<?php echo $this->get_field_id('numoption'); ?>" class="widefat">
                <?php
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('maxposts'); ?>"><?php _e('How many posts per feed?', 'wp-rss-multi-importer'); ?></label>
            <select name="<?php echo $this->get_field_name('maxposts'); ?>"
                    id="<?php echo $this->get_field_id('maxposts'); ?>" class="widefat">
                <?php
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('background'); ?>"><?php _e('Background Color:', 'wp-rss-multi-importer'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('background'); ?>"
                   name="<?php echo $this->get_field_name('background'); ?>" type="text" value="<?php if ($background) {
                echo $background;
            } else {
                echo '#cccccc';
            } ?>"/>
