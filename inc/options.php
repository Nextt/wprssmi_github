    ...
    <div class="wrap">
        ...
        <div id="poststuff">
            ...
            <form action="options.php" method="post" class="catform">
                ...
                <div class="postbox">
                    <div class="inside">
                        <h3><?php _e("Set a Default Feed Category Image, Post Category Tags and Post Category Word Filters for Feed to Post (all are optional) -", 'wp-rss-multi-importer')?></h3>
...
function wp_rss_multi_importer_intro_page()
{
    ...
    <div class="wrap">
        ...
        <div class="postbox-container" style="min-width:400px; max-width:600px; padding: 0 20px 0 0;"><h2>Put RSS Feeds
                on Your Site in 3 Different Ways</h2>
        ...
        <div class="postbox-container" style="width:25%;min-width:200px;max-width:350px;">
            <div id="sidebar" class="MP_box">
                ...
                <ul class="padding_nomargin txtleft"
                    style="margin-left:30px;padding-top:5px;padding-bottom:5px;margin-top:0px;">
                ...
                <form style="padding-bottom:4px;" onsubmit="validateEmail(document.getElementById('e'));"
                      action="https://www.marketingprofs.com/login/signup.asp" method="POST">
                    <div class="center width_full"><input type="text" onfocus="this.value=''" value="you@company.com"
                                                          style="width:225px;color:#444;" id="e" name="e"></div>
                    <div class="center width_full"><input type="image" style="margin-top:4px;"
                                                          src="http://www.mpdailyfix.com/wp-content/themes/mpdailyfix/images/signup_blue.gif"
                                                          id="btnsignup" name="btnsignup"></div>
                ...
                <span class="MP_title">	<a class="button-primary" style="text-align:center"
                                              href="https://www.marketingprofs.com/login/join?adref=amwplugin"
            ...
            <div id="sidebar" class="MP_box">
                ...
                <p><a href="http://www.allenweiss.com/wp_plugin/" target="_blank" style="color:white">Go here</a> to
                    find FAQs, our discussion board, template examples, and more.</p>

                <p><a href="http://www.allenweiss.com/faqs/im-told-the-feed-isnt-valid-or-working/" target="_blank"
                      style="color:white">Go here if you have a feed that isn't working</a>
...
function wp_rss_multi_importer_options_page()
{
    ...
    <div class="postbox"><h3><label
            for="title"><?php _e("Options Settings for Displaying the Feed Items", 'wp-rss-multi-importer')?></label>
    </h3>

    <p style="margin-left:20px">These are settings for the option to display the feed items on your site. If you want
        the settings for the Feed to Post option, use that tab instead.</p>
    ...
    <p><label class='o_textinput'
              for='sortbydate'><?php _e("Sort Output by Date (Descending = Closest Date First", 'wp-rss-multi-importer')?></label>
    ...
    <p><label class='o_textinput'
              for='maxfeed'><?php _e("Number of Entries per Feed", 'wp-rss-multi-importer')?></label>
    ...
    <p><label class='o_textinput'
              for='maxperPage'><?php _e("Number of Entries per Page of Output", 'wp-rss-multi-importer')?></label>
    ...
    <p><label class='o_textinput' for='pag'><?php _e("Do you want pagination?", 'wp-rss-multi-importer')?></label>
        ...
        </SELECT>  <?php _e("(Note: this will override the Number of Entries per Page of Output)", 'wp-rss-multi-importer')?>
    </p>
...
<span id="pag_options" <?php if ($options['pag'] == 0) {
	...
	<p style="padding-left:15px"><label class='o_textinput'
                                        for='perPage'><?php _e("Number of Posts per Page for Pagination", 'wp-rss-multi-importer')?></label>
    ...
    <p style="padding-left:15px"><label class='o_textinput' for='noFollow'>Set links as No Follow. <input
                type="checkbox" Name="rss_import_options[noFollow]" Value="1" <?php if ($options['noFollow'] == 1) {
    ...
    <p><label class='o_textinput'
              for='addAuthor'><?php _e("Show Feed or Author Name (if available)", 'wp-rss-multi-importer')?>   <input
                type="checkbox" Name="rss_import_options[addAuthor]" Value="1" <?php if ($options['addAuthor'] == 1) {
                echo 'checked="checked"';
            } ?></label></p>
    ...
    <p style="padding-left:15px"><label class='o_textinput'
            ...
            <input type="checkbox" Name="rss_import_options[showcategory]"
                   Value="1" <?php if ($options['showcategory'] == 1) {
                echo 'checked="checked"';
            } ?></label></p>
...
<span id="secret" <?php if ($options['showdesc'] == 0) {
	...
	<p style="padding-left:15px"><label class='o_textinput'
            ...
            <input type="checkbox" Name="rss_import_options[showmore]" Value="1" <?php if ($options['showmore'] == 1) {
                echo 'checked="checked"';
            } ?></label>
    </p>
...
<p><label class='o_textinput'
          for='stripAll'><?php _e("Check to get rid of all images in the excerpt.", 'wp-rss-multi-importer')?><input
            type="checkbox" Name="rss_import_options[stripAll]" Value="1" <?php if ($options['stripAll'] == 1) {
            echo 'checked="checked"';
        } ?></label>
</p>
<p><label class='o_textinput'
          for='anyimage'><?php _e("Check to use any image in the content if possible", 'wp-rss-multi-importer')?><input
            type="checkbox" Name="rss_import_options[anyimage]" Value="1" <?php if ($options['anyimage'] == 1) {
            echo 'checked="checked"';
        } ?></label>
</p>
...
<p style="padding-left:15px"><label class='o_textinput'
    ...
    <p><label class='o_textinput'
              for='cacheMin'><?php _e("Number of minutes you want the post data held in cache (match to how often your feeds are updated)", 'wp-rss-multi-importer')?></label>
        <SELECT NAME="rss_import_options[cacheMin]" id="cacheMin">
            <OPTION VALUE="0" <?php if ($options['cacheMin'] == 0) {
                echo 'selected';
            } ?>>Turn off caching
            </OPTION>
            <OPTION VALUE="1" <?php if ($options['cacheMin'] == 1) {
                echo 'selected';
            } ?>>1
            </OPTION>
            <OPTION VALUE="5" <?php if ($options['cacheMin'] == 5) {
                echo 'selected';
            } ?>>5
            </OPTION>
            <OPTION VALUE="10" <?php if ($options['cacheMin'] == 10) {
                echo 'selected';
            } ?>>10
            </OPTION>
            <OPTION VALUE="20" <?php if ($options['cacheMin'] == 20) {
                echo 'selected';
            } ?>>20
            </OPTION>
            <OPTION VALUE="30" <?php if ($options['cacheMin'] == 30) {
                echo 'selected';
            } ?>>30
            </OPTION>
            <OPTION VALUE="40" <?php if ($options['cacheMin'] == 40) {
                echo 'selected';
            } ?>>40
            </OPTION>
            <OPTION VALUE="60" <?php if ($options['cacheMin'] == 60) {
                echo 'selected';
            } ?>>60
            </OPTION>
            <OPTION VALUE="120" <?php if ($options['cacheMin'] == 120) {
                echo 'selected';
            } ?>>120
            </OPTION>
            <OPTION VALUE="180" <?php if ($options['cacheMin'] == 180) {
                echo 'selected';
            } ?>>180
            </OPTION>
            <OPTION VALUE="240" <?php if ($options['cacheMin'] == 240) {
                echo 'selected';
            } ?>>240
            </OPTION>
            <OPTION VALUE="300" <?php if ($options['cacheMin'] == 300) {
                echo 'selected';
            } ?>>300
            </OPTION>
        </SELECT></p>
    ...
    <p><label class='o_textinput'
            ...
            <input type="checkbox" Name="rss_import_options[cb]" Value="1" <?php if ($options['cb'] == 1) {
                echo 'checked="checked"';
            } ?></label></p>


    <p><label class='o_textinput'
              for='cb'><?php _e("Check if you want to suppress warning messages.", 'wp-rss-multi-importer')?>   <input
                type="checkbox" Name="rss_import_options[warnmsg]" Value="1" <?php if ($options['warnmsg'] == 1) {
                echo 'checked="checked"';
            } ?></label></p>
    ...
    <div class="postbox"><h3><label for="title"><?php _e("Help Others", 'wp-rss-multi-importer')?></label></h3>

        <div
            class="inside"><?php _e("If you find this plugin helpful, let others know by <a href=\"http://wordpress.org/extend/plugins/wp-rss-multi-importer/\" target=\"_blank\">rating it here</a>.  That way, it will help others determine whether or not they should try out the plugin.  Thank you.", 'wp-rss-multi-importer')?></div>
    </div>
...
<?php
                    ...
                    <div id="buttons"><a href="javascript:void(0)" id="add" class="addbutton"><img
                                src="<?php echo WP_RSS_MULTI_IMAGES; ?>add.png"></a>
                ...
                <div class="postbox"><h3><label
                            for="title">   <?php _e("Help Others", 'wp-rss-multi-importer')?></label></h3>
                ...
                <form action="options.php" method="post">
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <p><label class='o_textinput'
                                      for='feedtitle'><?php _e("Feed Title", 'wp-rss-multi-importer')?></label>

                                <input id="feedtitle" type="text" value="<?php echo $options['feedtitle']?>"
                                       name="rss_feed_options[feedtitle]"></p>

                            <p><label class='o_textinput'
                                      for='feedslug'><?php _e("Feed Slug", 'wp-rss-multi-importer')?></label>

                                <input id="feedslug" size="10" type="text" value="<?php echo $options['feedslug']?>"
                                       name="rss_feed_options[feedslug]"> <?php _e("(no spaces are allowed!  See what a slug is below)", 'wp-rss-multi-importer')?>
                            </p>

                            <p><label class='o_textinput'
                                      for='feeddesc'><?php _e("Feed Description", 'wp-rss-multi-importer')?></label>

                                <input id="feeddesc" type="text" value="<?php echo $options['feeddesc']?>"
                                       name="rss_feed_options[feeddesc]" size="50"></p>

                            <p><label class='o_textinput'
                                      for='striptags'><?php _e("Check to get rid of all images in the feed output.", 'wp-rss-multi-importer')?>
                                    <input type="checkbox" Name="rss_feed_options[striptags]"
                                           Value="1" <?php if ($options['striptags'] == 1) {
                                        echo 'checked="checked"';
                                    } ?></label>
                            </p>
...
function wp_rss_multi_importer_post_page()
{
    ...
    <p><label class='o_textinput'
              for='fetch_schedule'><?php _e("How often to import feeds (<a href=\"http://www.allenweiss.com/faqs/how-to-have-more-control-over-scheduling-of-feteching-feeds//\" target=\"_blank\">click here to learn how to have more control over this</a>)", 'wp-rss-multi-importer')?></label>
    ...
    <p><label class='o_textinput'
              for='maxfeed'><?php _e("Number of Entries per Feed to Fetch", 'wp-rss-multi-importer')?></label>
    ...
    <p><label class='o_textinput'
              for='maxperfetch'><?php _e("Number of Total Post Entries per Fetch (should be much greater than the number of entries per feed)", 'wp-rss-multi-importer')?></label>
    ...
    <p><label class='o_textinput'
        ...
        </SELECT><?php _e("  NOTE: Choosing Give me everything will prohibit you from getting a Featured Image", 'wp-rss-multi-importer')?>
    </p>
...
<p><label class='o_textinput'
    ...
    <button type="button" name="fetchnow" id="fetch-now"
            value=""><?php _e("CLICK TO FETCH FEEDS NOW", 'wp-rss-multi-importer')?></button>
    <div id="note"></div>
    </div>
    </div>
    </div>
